...
const _Input: React.FC<Props> = props => {
  ...
  return (
    <Pressable
      onPress={onPress}
      style={StyleSheet.flatten([_styles.container, props.viewStyle])}>
      <View style={_styles.row}>
        <Pressable onPress={onPressLeft}>
          <Image
            source={imageIconLeft}
            style={[_styles.iconLeft, props.iconLeftStyle]}
          />
        </Pressable>
        <TextInput
          placeholder={label}
      ...
      <Pressable onPress={onPressRight}>
        <Image
          ...
          style={StyleSheet.flatten([_styles.iconRight, props.iconRightStyle])}
        />
      </Pressable>
    </Pressable>
  );
