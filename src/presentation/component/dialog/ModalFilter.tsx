  ...
  const ItemDay = ({item, onPress}: ItemLocationProps) => (
    <TouchableOpacity
      ...
      style={[
        ...
        {
          backgroundColor:
            item.id === selectedId ? Colors.GREEN : Colors.GRAY_SEARCH,
        },
      ]}>
      <Text
        style={[
          _styles.text,
          {color: item.id === selectedId ? Colors.WHITE : Colors.BLUE_TEXT},
        ]}>
        {item.title}
      </Text>
    </TouchableOpacity>
  ...
  const ItemCountry = ({item, onPress}: ItemCountryProps) => (
    <TouchableOpacity
      ...
      style={[
        ...
        {
          backgroundColor:
            item.id === selected ? Colors.GREEN : Colors.GRAY_SEARCH,
        },
      ]}>
      <Text
        style={[
          _styles.text,
          {color: item.id === selected ? Colors.WHITE : Colors.BLUE_TEXT},
        ]}>
        {item.title}
      </Text>
    </TouchableOpacity>
              ...
              <View style={_styles.row}>
                <View style={_styles.container}>
                  <Pressable onPress={() => setModalVisibleLocation(true)}>
                    <Image source={ARROW_DOWN} style={_styles.iconLeft} />
                  </Pressable>
                  <Text>{location}</Text>
                  <Modal
                    animationType="slide"
