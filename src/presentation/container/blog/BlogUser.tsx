...
import {
    BlogStackParamList, ProfileStackParamList,
} from '@navigation';
...
import { RootState, getAllBlogs, getBlogUser, useAppDispatch } from '@shared-state';
...
const _BlogUser: React.FC<PropsType> = props => {
    ...
    const dataBlogs = useSelector(
        (state: RootState) => state.blog.dataBlogUser,
    );
