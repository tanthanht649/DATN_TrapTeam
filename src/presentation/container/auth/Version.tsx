    ...
    <BackgroundApp source={BACKGROUND_WHITE}>
      <SafeAreaView style={_styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <TextPlus
            text="Xin chào và xin cảm ơn vì đã cho tôi cơ hội giới thiệu phiên bản mới của ứng dụng đặt tour du lịch  Phiên bản v.1.0. Với ứng dụng này, chúng tôi mong muốn mang đến cho bạn trải nghiệm du lịch tuyệt vời và tiện lợi hơn bao giờ hết.
