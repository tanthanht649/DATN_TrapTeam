...
import {  BACKGROUND_WHITE, CALL, CAMERA, CAMERA_PROFILE, EMAIL_LOGIN, FULL_NAME, ICON_BACK, IMAGE_TEST, } from '@assets';
    ...
    <BackgroundApp source={BACKGROUND_WHITE}>
      ...
      <Header
       ...
       <View style={_styles.avatar}>
        ...
        <Input
          ...
          viewStyle={{ width: 327, alignSelf: 'center',marginTop:DimensionsStyle.height*0.02 }} ></Input>
          <Input
      ...
      <View style={_styles.bottom}>
        <Button title='Cập nhật'
          ...
          viewStyle={{ width: 278, marginTop: DimensionsStyle.height * 0.20 }}></Button>
      </View>
    </BackgroundApp>
  );
};
